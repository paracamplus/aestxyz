...
rt_ulimit -d  400$K # 400 meg (maximum size of a process's data segment)
...
rt_ulimit -m   50$K # 50 meg (maximum resident set size)
...
rt_ulimit -s   10$K # 10 meg (maximum stack size)
...
rt_ulimit -v  1200$K # 1200 meg (virtual memory)
