...
# Check syntax with /usr/sbin/apache2ctl -t
  ...
  ExpiresActive On
        ...
        <Directory /var/www/z.paracamplus.com/static/ >
              Options +FollowSymLinks
              Order allow,deny
              allow from all
...
# <Location> directives should be sorted from less to most precise:
        ...
        Errorlog /var/log/apache2/z.paracamplus.com-error.log
